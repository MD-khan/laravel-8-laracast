                ...
                <article class="max-w-4xl mx-auto lg:grid lg:grid-cols-12 gap-x-10">
                    ...
                    <div class="col-span-8">
                        <div class="hidden lg:flex justify-between mb-6">
                            ...
                            <div class="space-x-2">
                                <x-category-link-btn :category="$post->category" />

                                <a href="#" class="px-3 py-1 border border-red-300 rounded-full text-red-300 text-xs uppercase font-semibold" style="font-size: 10px">
