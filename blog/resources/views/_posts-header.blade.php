        ...
        <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
            ...
            <div x-data="{ show: false }" @click.away="show = false">
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 mt-2 rounded-xl  w-full z-50" style="display: none;">
                    ...
                    <a href="/" class="block  px3 leading-5 text-sm hover:bg-blue-500 focus:bg-blue-500 hover:text-white focus:text-white">
                       All
                    </a>
                    ...
                    <a href="/categories/{{ $category->slug}}" 
                        ...
                        block  px3 leading-5 text-sm hover:bg-blue-500 
